...
//无人机已经到达指定目标点
// void complete_status(const std_msgs::UInt8 msg){
//     nocomplete=msg.data;
//     //再次发送无人机，设置control_status为Stop_CONTROL
//     // std_msgs::UInt8 m;
//     // m.data=0;
//     // cmdStatusPub.publish(m);
// }
...
int main(int argc, char **argv)
{
    ...
    // getStatusSub = nh.subscribe<std_msgs::UInt8> ("/get_status",1,&complete_status);
