...
//FRD--ENU
  // synced_imu.angular_velocity.x    =  -hardSync_FC.w.y;
  // synced_imu.angular_velocity.y    =  hardSync_FC.w.x;
  // synced_imu.angular_velocity.z    =  -hardSync_FC.w.z;

  // synced_imu.linear_acceleration.x =   -hardSync_FC.a.y * p->gravity_const;
  // synced_imu.linear_acceleration.y =  hardSync_FC.a.x * p->gravity_const;
  // synced_imu.linear_acceleration.z =  -hardSync_FC.a.z * p->gravity_const;
  /*!
  ...
  //change(NED--ENU)
  // tf::Matrix3x3 R_NED2ENU;
  // R_NED2ENU[0]=tf::Vector3(0,1,0);
  // R_NED2ENU[1]=tf::Vector3(1,0,0);
  // R_NED2ENU[2]=tf::Vector3(0,0,-1);
  // tf::Matrix3x3 R_FRD2ENU=R_NED2ENU*R_FRD2NED;
  // tf::Quaternion q_FRD2ENU;
  // R_FRD2ENU.getRotation(q_FRD2ENU);
  ...
  // synced_imu.orientation.w = q_FRD2ENU.getW();
  // synced_imu.orientation.x = q_FRD2ENU.getX();
  // synced_imu.orientation.y = q_FRD2ENU.getY();
  // synced_imu.orientation.z = q_FRD2ENU.getZ();
